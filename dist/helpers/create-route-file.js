...
export const ${(0, lodash_1.camelCase)(
    (0, get_component_filename_1.getComponentFileName)(routeId, "")
...
`;
  ...
  const installDirectory = `${(0, process_1.cwd)()}/src/routes/${(0,
  get_component_root_1.getComponentRoot)(routeId)}`;
