...
newModule) => {
    const existingImports = (0, get_existing_imports_1.getExistingImports)(content);
    const updatedContent = (0, update_module_imports_1.updateModuleImports)(content, existingImports, newModule);
